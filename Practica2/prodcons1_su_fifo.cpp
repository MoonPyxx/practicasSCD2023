...
/* Portafolio:
  Además de los cambios de código y la inclusión de nuevas variables como primera_ocupada, etc, si utilizamos la opción FIFO,
  nuestro programa ejecutará todos los procesos de consumir/producir en orden, es decir, ambas hebras productora y consumidora
  irán desde el 0 al 14 estrictamente, ya que en una implementación FIFO se mantiene el orden de la cola, cosa que no siempre pasa en LIFO
  ya que por ejemplo,pongamos que la hebra productora produce 0 y 1 seguidos, en LIFO puede ocurrir que no se respete el orden
  y se consumiría 1 y después 0, mientras que en FIFO si se mantendría el orden de 0 y 1.
 */