...
int buffer[tam_vec], primera_libre = 0, primera_ocupada =0;

Semaphore
        libres(tam_vec),
        ocupadas(0),
        exclusion(1); // garantiza exclusion mutua por varias hebras
...
{
    cout << "-----------------------------------------------------------------" << endl
         << "Problema de los productores-consumidores con multiples hebras (solución FIFO)." << endl
         << "------------------------------------------------------------------" << endl
         << flush ;
